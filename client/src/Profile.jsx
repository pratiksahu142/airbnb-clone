      ...
      <div>
        <form onSubmit={saveProfile} className="mb-6">
          <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
            ...
            <div className="col-span-2 md:col-span-2">
              <div
                  className="grid grid-cols-2 md:grid-cols-2 md:gap-x-10 gap-x-5">
                <div>
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <input
                            ...
                            onChange={(ev) => setBusinessContact(
                                ev.target.value)}
                        />
                      </div>
                      <div>
                        ...
                        <input
                            ...
                            onChange={(ev) => setBusinessAddress(
                                ev.target.value)}
                        />
                      </div>
                      <div className="col-span-2">
                        ...
                        <input
                            ...
                            onChange={(ev) => setBusinessWebsite(
                                ev.target.value)}
                        />
                      </div>
                    </>
        ...
        {user && user.userType === "business" && (
            <>
              ...
              <div
                  className="grid grid-cols-1 mt-8 gap-x-6 gap-y-8 md:grid-cols-3 lg:grid-cols-4">
                {places.length > 0 &&
                    places.map((place) => (
