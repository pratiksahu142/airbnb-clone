        ...
        {bookings?.length > 0 &&
          bookings.map((booking) => (
            <div key={booking._id} className="relative">
              ...
              >
                <div className="md:w-48 lg:w-56 sm:w-40 sm:h-40">
                  <PlaceImg place={booking.place}  className="object-cover w-full h-full aspect-square"/>
                </div>
                <div className="py-3 pr-3 grow">
                  <h3 className="text-lg md:text-base">{booking.place.title}</h3>
                  <div className="">
                    <BookingDates
                      booking={booking}
