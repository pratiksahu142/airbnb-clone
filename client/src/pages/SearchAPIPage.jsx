...
export default function SearchAPIPage() {
  ...
  useEffect(() => {
    if (location && checkIn && checkOut && minPrice && maxPrice && numberOfGuests) {
  ...
  return (<div>
        <div className="mt-6 border border-gray-300 bg-white rounded-lg p-4 shadow-md grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
          ...
          <div>
            ...
            <p className="mb-1">
              <span className="font-semibold">Number of Guests:</span> {numberOfGuests}
            </p>
          </div>
        </div>
              ...
              <div>
                <Link to={'/search/api/detail/'+place.id}>
                  <div className="bg-gray-500 mb-2 rounded-2xl flex">
                    {place.photo && (
                        <img className=" rounded-2xl object-cover aspect-square" src={place.photo} alt=""/>
                    )}
                  </div>
