...
export default function PhotosUploader({addedPhotos, onChange, user}) {
  ...
  return (
      <>
        ...
        <div
            className="grid grid-cols-3 gap-2 mt-2 lg:grid-cols-6 md:grid-cols-4">
          {addedPhotos &&
                  ...
                  <div className="relative flex h-32" key={link}>
                    ...
                    {user && user.userType !== "admin" && (
                        <>
                          ...
                          <button
                              onClick={(ev) => setAsMainPhoto(ev, link)}
          ...
          {user && user.userType !== "admin" && (
              <label
                  className="flex items-center justify-center h-32 gap-1 p-2 text-2xl text-gray-600 bg-transparent border cursor-pointer rounded-2xl">
                <input
                    type="file"
                    multiple
                    className="hidden"
