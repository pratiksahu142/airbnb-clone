      ...
      <>
        <div className="flex gap-2">
          ...
          <button onClick={addPhotoByLink}
                  className="bg-gray-200 px-4 rounded-2xl">Grab photo
          </button>
        </div>


        <div
            className="mt-2 gap-2 grid grid-cols-3 lg:grid-cols-6 md:grid-cols-4">
          {addedPhotos && addedPhotos.length > 0 && addedPhotos.map(link => (
              <div className="h-32 flex relative" key={link}>
                ...
                <button onClick={(ev) => setAsMainPhoto(ev,link)}
